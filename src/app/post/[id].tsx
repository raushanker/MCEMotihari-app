...
export default function PostDetailScreen() {
  ...
  // 2.5 Keyboard listener to scroll comments smoothly and track visibility/height
  useEffect(() => {
  ...
  const handleShare = async () => {
    if (!activePost) return;
    try {
      const profileUrl = `https://mcemotihari.com/post/${activePost.id}`;
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        ...
        <View style={[styles.inputStickyBar, { backgroundColor: theme.backgroundElement, borderTopColor: theme.cardBorder, paddingBottom: Platform.OS === 'ios' ? 10 : (isKeyboardVisible ? 6 : Math.max(insets.bottom, 6)) }]}>
